...
export const DATA = {
  ...
  families: [
    { id: 'bonforte', name: 'Bonforte', address: '18 Creek Estates Dr', hometown: 'San Francisco, CA', cover: 'family/bonfortes.jpg',
      ...
      presence: { here: true, label: 'Here this weekend', days: ['thu', 'fri', 'sat', 'sun'] },
      members: [
    ...
    { id: 'bell', name: 'Bell', address: '12 Lookout Loop', hometown: 'Palo Alto, CA', cover: 'lodge.jpg',
      ...
      presence: { here: true, label: 'Here this weekend', days: ['fri', 'sat', 'sun'] },
      members: [
    ...
    { id: 'ford', name: 'Ford', address: '7 Camp Cir', hometown: 'Sacramento, CA', cover: 'family-barn.jpg',
      ...
      presence: { here: false, label: 'Not this weekend', days: [] },
      members: [
  ...
  gatherings: [
    ...
    { id: 'dinner-fri', title: 'Family dinner at the Bistro', amenity: 'dining', host: 'Rosa Alvarez', day: 'fri', when: 'Fri, Jul 11 · 6:30 PM',
      ...
      description: "Big table on the patio to kick off the weekend. Bring the whole crew — highchairs sorted for the little ones.",
  ...
  feed: [
    ...
    { id: 'f2', kind: 'arrival', who: 'The Alvarez family', avatar: null, tone: 'var(--lake-600)', text: 'is arriving Saturday for the weekend.', when: '1h ago', unread: true, familyId: 'alvarez' },
