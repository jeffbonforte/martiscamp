...
export const DATA = {
  ...
  gatherings: [
    ...
    { id: 'paddle-sat', title: 'Sunset paddle at the Lake Club', amenity: 'beach', host: 'Ben Kwan', day: 'sat', when: 'Sat, Jul 12 · 5:00 PM',
      where: 'The Lake Club', capacity: 10, myRsvp: null, visibility: 'open', youInvited: true,
  ...
  events: [
    ...
    { day: 12, dayKey: 'sat', date: WEEK_ISO.sat, title: 'Sunset paddle', place: 'The Lake Club', amenity: 'beach' },
  ...
  feed: [
    { id: 'f0', kind: 'announcement', who: 'Martis Camp', avatar: null, tone: 'var(--cedar-600)', text: 'Lake Club closed Saturday 8–11am for dock maintenance — pool open as usual.', when: '30m ago', unread: true },
    ...
    { id: 'f5', kind: 'rsvp', who: 'Ben Kwan', avatar: null, tone: 'var(--cedar-600)', text: 'is in for the Saturday paddle at the Lake Club.', when: 'Yesterday', unread: false, eventId: 'paddle-sat' },
